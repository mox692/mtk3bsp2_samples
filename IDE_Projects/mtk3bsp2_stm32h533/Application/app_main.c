...
/* ======================================================================== */
/*  CAN sample for NUCLEO-H533RE using the portable CAN driver.             */
/*                                                                          */
...
/*  CAN API (can_init / can_start / can_try_send / can_try_recv).           */
/*                                                                          */
...
EXPORT INT usermain(void)
{
	...
	/* Bring up FDCAN1 (Classic CAN 500 kbps, PB7=TX / PB8=RX). */
	if (can_board_init() != 0) {
